...
public class ManagersParent {
    ...
    @JSONField(ordinal = 6)
    private List<ManagersChildren> children;
    ...
    public List<ManagersChildren> getChildren() {
        return children;
    }

    public void setChildren(List<ManagersChildren> children) {
